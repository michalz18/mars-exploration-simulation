...
import com.codecool.marsexploration.exploration.logic.task.ExplorationTask;
...
public class ExplorationSimulator {
    ...
    public ExplorationSimulator(Logger logger, MissionDeployer missionDeployer, MapLoader mapLoader, ConfigurationValidator configurationValidator) {
        this.logger = logger;
    ...
    public void runSimulation(SimulationConfiguration configuration) {
        ...
        Rover rover = new Rover(2, spaceship, MovementStrategyType.EXPLORING);
